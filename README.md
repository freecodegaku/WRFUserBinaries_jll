# `WRFUserBinaries_jll.jl` (v0.0.1+0)
...
The tarballs for `WRFUserBinaries_jll.jl` have been built from these sources:

* git repository: https://github.com/NCAR/wrf-python.git (revision: `31c923335227b22fa656fd589a5342b91103e939`)

## Platforms

`WRFUserBinaries_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `WRFUserBinaries_jll.jl`:
